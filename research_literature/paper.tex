...
Our analysis spans \textbf{10 papers} (V4 plus 7 references), with 5 papers fully parsed at the paragraph level. We construct \textbf{72 atoms} and \textbf{123 relations}, achieving complete origin tracing for V4's core innovations:
...
\textbf{Construct validity:} The atom decomposition process involves subjective judgment. We follow explicit principles (one claim per atom, split conjunctions), but different researchers might produce different graphs. The 72-atom graph represents one valid decomposition, not the only one.
